    ...
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <!-- <img src="assets/logo.png" class="img-responsive" alt="<?= NAMA_WEB; ?>"> -->
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?= ($page === 'Mitra') ? 'active' : ''; ?>">
                            <a href="?page=Mitra" class="sidebar-link">
                        ...
                        <li class="sidebar-item <?= ($page === 'Kurir') ? 'active' : ''; ?>">
                            <a href="?page=Kurir" class="sidebar-link">
                                <i class="bi bi-truck"></i>
                                <span>Kurir</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?= ($page === 'Bank') ? 'active' : ''; ?>">
                            <a href="?page=Bank" class="sidebar-link">
                                <i class="bi bi-bank"></i>
                                <span>Bank</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?= ($page === 'Supplier') ? 'active' : ''; ?>">
                            <a href="?page=Supplier" class="sidebar-link">
        ...
        <div id="main">
            ...
            switch ($page) {
                ...
                // =====================
                case 'Users':
                    include 'pages/admin/kelola_user.php';
                    break;
                ...
                // =====================
                case 'Mitra':
                    include 'pages/admin/kelola_mitra.php';
                    break;
                ...
                // =====================
                case 'Produk':
                    include 'pages/admin/kelola_produk.php';
                    break;
                ...
                // =====================
                case 'Pesanan':
                    include 'pages/admin/kelola_pesanan.php';
                    break;
                ...
                // =====================
                case 'Kurir':
                    include 'pages/admin/kelola_kurir.php';
                    break;
                ...
                // =====================
                case 'Bank':
                    include 'pages/admin/kelola_bank.php';
                    break;
                ...
                // =====================
                case 'Supplier':
                    include 'pages/admin/kelola_supplier.php';
                    break;
                ...
                // =====================
                case 'Profil':
                    include 'pages/admin/kelola_profil.php';
                    break;
